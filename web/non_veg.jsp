<%-- 
    Document   : non_veg
    Created on : Jan 3, 2019, 2:30:05 PM
    Author     : USER
--%>
  ...
  <div class="container-fluid">
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
         ...
         <h1 style="color:red; font-size: 50px;text-align:center; font-family: helvetica"><b>NON-VEG PIZZAS</b></h1><br>
         <div class="container text-center" style="background-color:black ;" >  
           
  <div class="row">
      <div class="col-sm-4" >
        <h1 style="color:green;">PEPPER BARBECUE CHICKEN
</H1>
   ...
   <a href="pepper.jsp" class="btn btn-primary custom-btn">ORDER NOW</a>
    ...
    <div class="col-sm-4"> 
        <h1 style="color:red;">CHICKEN TIKKA
</H1>
