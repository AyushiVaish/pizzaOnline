<%-- 
    Document   : doubleCheese
    Created on : Jan 6, 2019, 3:36:37 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Double Cheese Order</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="doubleCheese">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="Double_Cheese_Margherita.jpg" class="img-circle">
            </div>
            <br>
            <h3> SELECT SIZE :</h3> <select name="size">
                 <option value="regular">   Regular 7''-Serves1  Rs.165</option>
                <option value="medium">Medium 10''-Serves2  Rs.305</option>
                 <option value="large">Large 13''-Serves3  Rs.495</option>
            </select>
       
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">New Hand Tossed Rs.195</option>
            <option value="wheat">Wheat Thin Crust Rs.245</option>
<option value="cheese">Cheese Burst Rs.294</option>
<option value="fresh">Fresh Pan Pizza Rs.230</option>
<option value="Multi">MultiGrain MultiGrain Rs.255</option>
