<%-- 
    Document   : cheeseNCorn
    Created on : Jan 6, 2019, 3:36:49 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Cheese N Corn Order</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="cheeseNCorn">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="Corn_&_Cheese.jpg" class="img-circle">
            </div>
            <br>
...
<option value="Multi">MultiGrain MultiGrain   Rs.365</option>
