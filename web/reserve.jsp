<%-- 
    Document   : reserve
    Created on : Jan 26, 2019, 6:49:58 PM
    Author     : USER
--%>
        ...
        <% 
         try {
             Class.forName("org.apache.derby.jdbc.ClientDriver").newInstance();
              ...
              Integer value2=Integer.parseInt(request.getParameter("People"));
              String value3=request.getParameter("date");
              String value4=request.getParameter("Message");
              String sql = "insert into reserve values(?,?,?,?)" ;
                ...
                out.print("Your Table has been reserved.");
                  %>
                  <h2>Thanks for Choosing us!!!<b>Welcome  &#9786</b></h2>
                  <center>  <a href="index.html"><b>Prev.</b></a> </center>
         <%                      
         }
