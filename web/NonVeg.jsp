<%-- 
    Document   : NonVeg
    Created on : Jan 6, 2019, 5:09:20 PM
    Author     : USER
--%>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="NonVeg">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="nonVegSupreme.jpg" class="img-circle">
            </div>
            <br>
              <h3> SELECT SIZE :</h3> <select name="size">
                 <option value="regular">Regular 7''-Serves1  Rs.295</option>
                <option value="medium">Medium 10''-Serves2  Rs.555</option>
                 <option value="large">Large 13''-Serves3  Rs.835</option>
            </select>
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">New Hand Tossed Rs.555</option>
            <option value="wheat">Wheat Thin Crust Rs.605</option>
<option value="cheese">Cheese Burst Rs.654</option>
<option value="fresh">Fresh Pan Pizza Rs.590</option>
<option value="Multi">MultiGrain MultiGrain Rs.615</option>
            </select>
      ...
      <input type="checkbox" style="margin-top: 5%" name="add">  
           <h4 style="color: white;">  Add Extra Cheese @Rs.65</h4>
             ...
             <h3 name="topveg"> ADD VEG TOPPINGS @ 50 EACH :</h3> 
               ...
               <h3 name="topnov"> ADD NON-VEG TOPPINGS @ 65 EACH :</h3> 
           ...
           <input type="submit" value="Order now" class="btn btn-primary custom-btn" style="margin-top: 5%; margin-bottom: 5%">        </div>
        </div>
        </form>
              <br><br>
