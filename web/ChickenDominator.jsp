<%-- 
    Document   : ChickenDominator
    Created on : Jan 6, 2019, 5:09:50 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>CHICKEN DOMINATOR ORDER</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="ChickenDominator">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="chickenDominator.jpg" class="img-circle">
            </div>
            <br>
      ...
      <input type="checkbox" style="margin-top: 5%" name="add">  
           <h4 style="color: white;">  Add Extra Cheese @Rs.65</h4>
             ...
             <h3 name="topveg"> ADD VEG TOPPINGS @ 50 EACH :</h3> 
               ...
               <h3 name="topnon"> ADD NON-VEG TOPPINGS @ 65 EACH :</h3> 
