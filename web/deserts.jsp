<%-- 
    Document   : deserts
    Created on : Jan 3, 2019, 3:52:50 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>DESERTS VARIETY</title> <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <div class="container">
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <h1 style="color:red; font-size: 50px;text-align:center; font-family: helvetica"><b>DESERTS</b></h1><br>
        <div class="container">
       <div class="col-sm-2">
