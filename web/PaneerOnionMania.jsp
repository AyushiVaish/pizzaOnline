<%-- 
    Document   : PaneerOnionMania
    Created on : Jan 7, 2019, 12:30:38 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>PANEER & ONION MANIA ORDER</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" method="PaneerOnionMania">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="paneerOnion.jpg" class="img-circle">
            </div>
            <br>
          ...
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">Classic Hand Tossed Rs.89</option>
     
<option value="fresh">Fresh Pan Pizza Rs.114</option>
