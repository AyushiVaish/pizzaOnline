<%-- 
    Document   : ChickenTikka
    Created on : Jan 6, 2019, 5:09:08 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>CHICKEN TIKKA ORDER</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="ChickenTikka">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="Chicken_Tikka.jpg" class="img-circle">
            </div>
            <br>
