<%-- 
    Document   : beverages
    Created on : Jan 3, 2019, 3:56:21 PM
    Author     : USER
--%>
  ...
  <div class="container-fluid">
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <h1 style="color:red; font-size: 50px;text-align:center; font-family: helvetica"><b>BEVERAGES</b></h1><br>
     <div class="container">
       <div class="col-sm-1">
    ...
    <div class="col-sm-12"> 
        <H1 style="color:maroon;">Pepsi

</H1>
      <img src="pepsi.jpg" class="img-circle"  style="width:80%" alt="Image">
      <br>
      <br>
