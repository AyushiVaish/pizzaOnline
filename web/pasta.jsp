<%-- 
    Document   : pasta
    Created on : Jan 3, 2019, 3:43:06 PM
    Author     : USER
--%>
  ...
  <div class="container">
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <h1 style="color:red; font-size: 50px;text-align:center; font-family: helvetica"><b>PASTA/b></h1><br>
        <div class="container">
       <div class="col-sm-2">
    ...
    <div class="col-sm-6"> 
        <H1 style="color:blue;">Veg Pasta Italiano White
