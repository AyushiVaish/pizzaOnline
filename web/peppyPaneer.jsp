<%-- 
    Document   : peppyPaneer
    Created on : Jan 6, 2019, 3:37:44 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Peppy Paneer Order</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="pepperPaneer">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="Peppy_Paneer.jpg" class="img-circle">
            </div>
            <br>
