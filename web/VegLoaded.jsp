<%-- 
    Document   : VegLoaded
    Created on : Jan 7, 2019, 12:29:10 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>VEG LOADED MANIA ORDER</title>
