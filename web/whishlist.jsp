<%-- 
    Document   : whishlist
    Created on : Mar 27, 2019, 6:38:39 PM
    Author     : Aayu
--%>
        ...
        <% 
         try {
             Class.forName("org.apache.derby.jdbc.ClientDriver").newInstance();
              String value1=request.getParameter("whish");
                 String value2=request.getParameter("email");
              String sql = "insert into whishlist values(?,?)" ;
                connection = DriverManager.getConnection(connectionURL,"pizza","pizza");
                statement=connection.prepareStatement(sql);
                statement.setString(1,value1);
                 statement.setString(2,value2);
                  statement.executeUpdate();
                  out.print("Your items are successfully added to your WhishList.");
                  %>
