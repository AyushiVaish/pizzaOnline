<%-- 
    Document   : VeggiePara
    Created on : Jan 6, 2019, 3:38:14 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Veggie Paradise Order</title>
        ...
        <div class="form-area">
            ...
            <h3> SELECT SIZE :</h3> <select name="size">
                ...
                <option value="medium">Medium 10''-Serves2  Rs.385</option>
                 <option value="large">Large 13''-Serves3  Rs.505</option>
            </select>
