<%-- 
    Document   : ChickenFiesta
    Created on : Jan 6, 2019, 5:08:56 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>CHICKEN FIESTA ORDER</title>
  ...
  <div class="container-fluid">
    ...
    <form method="post">
        ...
        <div class="form-area">
            ...
            <div class="img-area">
                <img src="chickenFista.png" class="img-circle">
            </div>
            <br>
...
<option value="Multi">MultiGrain MultiGrain Rs.510</option>
      ...
      <input type="checkbox" style="margin-top: 5%">  
          ...
          <a href="#" class="btn btn-primary custom-btn" style="margin-top: 5%; margin-bottom: 5%">Order Now</a></br>
