<%-- 
    Document   : PaneerMakhani
    Created on : Jan 6, 2019, 3:38:27 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Paneer Makhani Order</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="PaneerMakhani">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="Paneer_Makhni.jpg" class="img-circle">
            </div>
            <br>
