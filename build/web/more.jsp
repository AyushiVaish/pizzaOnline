<%-- 
    Document   : more
    Created on : Jan 3, 2019, 3:56:32 PM
    Author     : USER
--%>
  ...
  <div class="container">
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <h1 style="color:red; font-size: 50px;text-align:center; font-family: helvetica"><b>MORE</b></h1><br>
        <div class="container">
       <div class="col-sm-2">
    ...
    <div class="col-sm-4"> 
        <H1 style="color:blue;">Potato Cheese Shots
...
<a href="#" class="btn btn-primary custom-btn">ORDER NOW</a>
        ...
        <div class="row">
             ...
             <div class="col-sm-4">
        <H1 style="color:blue;">Veg Parcel
