<%-- 
    Document   : CheesyMania
    Created on : Jan 7, 2019, 12:30:07 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>CHEESY MANIA ORDER</title>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="CheesyMania">
        ...
        <div class="form-area">
          ...
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">Classic Hand Tossed Rs.95</option>
     
<option value="fresh">Fresh Pan Pizza Rs.120</option>
