<%-- 
    Document   : HomeDelivery
    Created on : Feb 5, 2019, 6:14:02 PM
    Author     : USER
--%>
        ...
        <% 
         try {
             Class.forName("org.apache.derby.jdbc.ClientDriver").newInstance();
              ...
              String value2=request.getParameter("address");
              Integer value3=Integer.parseInt(request.getParameter("number"));
              String sql = "insert into HomeDelivery values(?,?,?)" ;
                connection = DriverManager.getConnection(connectionURL,"pizza","pizza");
                statement=connection.prepareStatement(sql);
                statement.setString(1,value1);
                 statement.setString(2,value2);
                  statement.setInt(3,value3);
                  statement.executeUpdate();
                  out.print(" <center>Your order will be soon arrive </center>");
                  %>
