<%-- 
    Document   : NonVegLoaded
    Created on : Jan 7, 2019, 12:28:54 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>NON VEG LOADED MANIA ORDER</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="NonVegLoaded">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="nonVegLoaded.jpg" class="img-circle">
            </div>
            <br>
