<%-- 
    Document   : PepperBarbecueMania
    Created on : Jan 7, 2019, 12:29:53 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>PEPPER BARBECUE CHICKEN MANIA ORDER</title>
  ...
  <div class="container-fluid">
    ...
    <form method="post">
        ...
        <div class="form-area">
            ...
            <div class="img-area">
                <img src="pepper.jpg" class="img-circle">
            </div>
            <br>
          ...
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">Classic Hand Tossed Rs.99</option>
     
<option value="fresh">Fresh Pan Pizza Rs.124</option>
