<%-- 
    Document   : home
    Created on : Jan 6, 2019, 1:27:46 PM
    Author     : USER
--%>
  ...
  <div class="container-fluid">
    ...
    <form method="post">
        ...
        <div class="form-area">
            ...
            <div class="img-area">
                <img src="Margherit.jpg" class="img-circle">
            </div>
            <br>
            <h3> SELECT SIZE :</h3> <select name="size">
                 <option value="regular">   Regular 7''-Serves1  Rs.99</option>
                <option value="medium">Medium 10''-Serves2  Rs.195</option>
                 <option value="large">Large 13''-Serves3  Rs.395</option>
            </select>
