<%-- 
    Document   : chickenSausage
    Created on : Jan 6, 2019, 5:07:33 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>CHICKEN SAUSAGE ORDER</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="chickenSausage">
        <div style="background-image:url(pizza.jpg)">
        <div class="form-area">
            <h1 STYLE="COLOR:RED">PLACE ORDER</h1>
            <div class="img-area">
                <img src="ChickenSausage.jpg" class="img-circle">
            </div>
            <br>
          ...
          <h3>CRUST</h3>
          <select name="crust">  
              <option value="new">New Hand Tossed Rs.305</option>
            <option value="wheat">Wheat Thin Crust Rs.355</option>
<option value="cheese">Cheese Burst Rs.404</option>
<option value="fresh">Fresh Pan Pizza Rs.340</option>
<option value="Multi">MultiGrain MultiGrain Rs.356</option>
            </select>
